...
Partial Public Class fileportalDataSet1
    ...
    Partial Public Class filedataDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddfiledataRow(ByVal parentassignmentRowByFK_filedata_Assignment As assignmentRow, ByVal filename As String, ByVal username As String, ByVal uploaded As Boolean, ByVal audience As String, ByVal marked As Boolean, ByVal dateSub As Date, ByVal sync As Boolean) As filedataRow
            Dim rowfiledataRow As filedataRow = CType(Me.NewRow,filedataRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nothing, filename, username, uploaded, audience, marked, dateSub, sync}
    ...
    Partial Public Class filedataTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[filedata] WHERE (([idFiledata] = @Original_idFiledata) AND ([i"& _ 
                ...
                "= @Original_dateSub) AND ([sync] = @Original_sync))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[filedata] ([idAssignment], [filename], [username], [uploaded],"& _ 
                " [audience], [marked], [dateSub], [sync]) VALUES (@idAssignment, @filename, @use"& _ 
                "rname, @uploaded, @audience, @marked, @dateSub, @sync);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT idFiledata, idAs"& _ 
                "signment, filename, username, uploaded, audience, marked, dateSub, sync FROM fil"& _ 
                "edata WHERE (idFiledata = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[filedata] SET [idAssignment] = @idAssignment, [filename] = @filenam"& _ 
                ...
                "ed] = @marked, [dateSub] = @dateSub, [sync] = @sync WHERE (([idFiledata] = @Orig"& _ 
                "inal_idFiledata) AND ([idAssignment] = @Original_idAssignment) AND ([filename] ="& _ 
                " @Original_filename) AND ([username] = @Original_username) AND ([uploaded] = @Or"& _ 
                "iginal_uploaded) AND ([audience] = @Original_audience) AND ([marked] = @Original"& _ 
                "_marked) AND ([dateSub] = @Original_dateSub) AND ([sync] = @Original_sync));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SE"& _ 
                "LECT idFiledata, idAssignment, filename, username, uploaded, audience, marked, d"& _ 
                "ateSub, sync FROM filedata WHERE (idFiledata = @idFiledata)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT idFiledata, idAssignment, filename, username, uploaded, audience, marked, "& _ 
                "dateSub, sync FROM dbo.filedata"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(1).CommandText = "SELECT        idFiledata, idAssignment, filename, username, uploaded, audience, m"& _ 
                "arked, dateSub, sync"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            filedata"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (sync = 1) AND (upl"& _ 
                "oaded = 0)"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal idAssignment As Integer, ByVal filename As String, ByVal username As String, ByVal uploaded As Boolean, ByVal audience As String, ByVal marked As Boolean, ByVal dateSub As Date, ByVal sync As Boolean) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_idFiledata,Integer)
            Me.Adapter.UpdateCommand.Parameters(9).Value = CType(Original_idAssignment,Integer)
            If (Original_filename Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_filename")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_uploaded,Boolean)
            If (Original_audience Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_audience")
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_audience,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_marked,Boolean)
            Me.Adapter.UpdateCommand.Parameters(15).Value = CType(Original_dateSub,Date)
            Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_sync,Boolean)
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(idFiledata,Integer)
            Dim previousConnectionState As Global.System.Data.ConnectionState = Me.Adapter.UpdateCommand.Connection.State
            If ((Me.Adapter.UpdateCommand.Connection.State And Global.System.Data.ConnectionState.Open)  _
                        <> Global.System.Data.ConnectionState.Open) Then
                Me.Adapter.UpdateCommand.Connection.Open
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_marked As Boolean,  _
                    ByVal Original_dateSub As Date,  _
                    ByVal Original_sync As Boolean) As Integer
            Return Me.Update(idAssignment, filename, username, uploaded, audience, marked, dateSub, sync, Original_idFiledata, Original_idAssignment, Original_filename, Original_username, Original_uploaded, Original_audience, Original_marked, Original_dateSub, Original_sync, Original_idFiledata)
        End Function
    End Class
